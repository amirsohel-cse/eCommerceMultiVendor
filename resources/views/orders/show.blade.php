    	...
    	<div class="panel-body">
    		...
    		<div class="clearfix">
    			...
    			<tr>
    				...
    				<td>
                        {{ single_price(json_decode($order->shipping_address)->vat) }}
    				</td>
    			</tr>
                <tr>
    				<td>
    				...
    				<td>
    					{{ single_price(json_decode($order->shipping_address)->shipping_cost) }}
    				</td>
    			</tr>
                <tr>
                    <td>
                        <strong>{{__('Shipping VAT')}} ({{json_decode($order->shipping_address)->shipping_charge_vat_percentage}}%) :</strong>
                    </td>
                    <td>
                      {{ single_price(json_decode($order->shipping_address)->shipping_charge_vat) }}
                    </td>
                </tr>
    			<tr>
    				<td>
