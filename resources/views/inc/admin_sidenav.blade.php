                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                <li class="{{ areActiveRoutes(['stock_report.index'])}}">
                                    <a class="nav-link" href="{{ route('stock_report.index') }}">{{__('Inventory Report')}}</a>
                                </li>
...
{{--                                </li>--}}
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['sms_settings.index'])}}">
                                    <a class="nav-link" href="{{ route('sms_settings.index') }}">{{__('SMS Settings')}}</a>
                                </li>
                                ...
                                <li class="{{ areActiveRoutes(['invoices.index'])}}">
                        ...
                        @if(Auth::user()->user_type == 'admin' ||  in_array('15', json_decode(Auth::user()->staff->role->permissions)))
                            <li>
                                <a href="#">
                                    <i class="fa fa-user"></i>
                                    <span class="menu-title">My Drivers</span>
                                    <i class="arrow"></i>
                                </a>
                                ...
                                <ul class="collapse">
                                    <li class="">
                                        <a class="nav-link" href="{{ route('driver.index') }}">All Driver</a>
                                    </li>
                                    <li class="">
                                        <a class="nav-link" href="{{route('driver.create')}}">Add New Driver</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
