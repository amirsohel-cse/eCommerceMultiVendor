...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">{{__('ByanPay Credential')}}</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                    @csrf
                    <input type="hidden" name="payment_method" value="byanpay">
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="BYAN_MERCHANT_ID">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('MERCHANT ID')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="BYAN_MERCHANT_ID" value="{{  env('BYAN_MERCHANT_ID') }}" placeholder="BYAN MERCHANT ID" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="BYAN_MERCHANT_NAME">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('MERCHANT NAME')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="BYAN_MERCHANT_NAME" value="{{  env('BYAN_MERCHANT_NAME') }}" placeholder="BYAN MERCHANT NAME" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="BYAN_MERCHANT_KEY">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('MERCHANT KEY')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="BYAN_MERCHANT_KEY" value="{{  env('BYAN_MERCHANT_KEY') }}" placeholder="BYAN MERCHANT KEY" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="BYAN_URL">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('BYAN URL')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="BYAN_URL" value="{{  env('BYAN_URL') }}" placeholder="BYAN URL" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="BYAN_COLLAB">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('BYAN COLLAB ID')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="BYAN_COLLAB" value="{{  env('BYAN_COLLAB') }}" placeholder="BYAN COLLAB ID" required>
                        </div>
                    </div>
