...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">Set Shipping Cost</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <div class="col-lg-3">
                            <label class="control-label">Set Shipping Cost</label>
                        </div>
                        <div class="col-lg-6">
                            @php
                                $shipping_charge_data = \App\BusinessSetting::where('type','shipping_cost')->first();
                                $shipping_charge = $shipping_charge_data->value;
                            @endphp
                            <input type="hidden" name="types[]" value="shipping_cost">
                            <input type="text" name="shipping_cost" value="{{$shipping_charge}}">
                        </div>
                        <div class="col-lg-3">
                            <button class="btn btn-purple" type="submit">{{__('Save')}}</button>
                        </div>
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">Set Delivery Vat Percentage</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <div class="col-lg-3">
                            <label class="control-label">Set Delivery Vat Percentage </label>
                        </div>
                        <div class="col-lg-6">
                            @php
                                $delivery_vat_percentage_data = \App\BusinessSetting::where('type','delivery_vat_percentage')->first();
                                $delivery_vat_percentage = $delivery_vat_percentage_data->value;
                            @endphp
                            <input type="hidden" name="types[]" value="delivery_vat_percentage">
                            <input type="text" name="delivery_vat_percentage" value="{{$delivery_vat_percentage}}">
                        </div>
                        <div class="col-lg-3">
                            <button class="btn btn-purple" type="submit">{{__('Save')}}</button>
                        </div>
