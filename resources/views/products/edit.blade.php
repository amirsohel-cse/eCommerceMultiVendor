				    ...
				    <div class="tab-content">
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-lg-7">
	                                <input type="number" min="0" step="0.01" placeholder="{{__('tax')}}" name="tax" class="form-control" value="{{$product->tax}}" readonly required>
	                            </div>
	                            <div class="col-lg-1">
	                                <select class="demo-select2" name="tax_type" required>
	                                	<option disabled value="amount" <?php if($product->tax_type == 'amount') echo "selected";?> >$</option>
