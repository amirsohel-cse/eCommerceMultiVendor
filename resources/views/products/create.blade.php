				...
				<div class="tab-base tab-stacked-left">
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
                           ...
                           {{-- Start SKU Code--}}
                            <div class="form-group">
                                <label class="col-lg-2 control-label">SKU Code</label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" name="sku_code" placeholder="SKU code" onchange="update_sku()" required>
                                </div>
                            </div>
                            {{-- End SKU Code--}}
                            ...
                            {{-- Start DIV Code--}}
                            <div class="form-group">
                                <label class="col-lg-2 control-label">DIV Code</label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" name="div_code" placeholder="Div code" onchange="update_sku()" required>
                                </div>
                            </div>
                            {{-- End DIV Code--}}
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="number" min="0" value="5" step="0.01" placeholder="{{__('Tax')}}" name="tax" class="form-control" readonly required>
								</div>
								<div class="col-lg-1">
									<select class="demo-select2" name="tax_type">
                                        <option value="amount" disabled>$</option>
