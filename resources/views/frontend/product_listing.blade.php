                    ...
                    <div class="bg-white sidebar-box mb-3">
                        ...
                        <div class="box-content">
                            <div class="range-slider-wrapper mt-3">
                                ...
                                <div id="input-slider-range" data-range-value-min="<?php echo (floor(filter_products(\App\Product::query())->get()->min('unit_price')))?>" data-range-value-max="<?php echo (ceil(filter_products(\App\Product::query())->get()->max('unit_price')))?>"></div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <span class="range-slider-value value-low"
                                            @if (isset($min_price))
                                                data-range-value-low="<?php echo (floor($min_price))?>"
                                            @elseif($products->min('unit_price') > 0)
                                                data-range-value-low="<?php echo (floor( $products->min('unit_price')))?>"
                                            @else
                                    ...
                                    <div class="col-6 text-right">
                                        <span class="range-slider-value value-high"
                                            @if (isset($max_price))
                                                data-range-value-high="<?php echo (ceil($max_price))?>"
                                            @elseif($products->max('unit_price') > 0)
                                                data-range-value-high="<?php echo (ceil( $products->max('unit_price')))?>"
                                            @else
