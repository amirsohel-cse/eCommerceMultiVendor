...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::get('/sms-settings', 'BusinessSettingsController@sms_settings')->name('sms_settings.index');
    ...
    Route::patch('/invoice-save', 'InvoiceController@save_form')->name('invoice.save');
