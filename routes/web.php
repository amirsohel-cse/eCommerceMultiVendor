...
|
*/
Route::get('test/{phn}', function($phn){

	$rtn = sendSMS($phn, 'This is demo msg from sunbulahome');
	dd($rtn);
});
...
//Phone Verification
Route::get('/phn/send-code', 'HomeController@sendCode')->name('phn.sendCode');
Route::get('/phn/verify-code', 'HomeController@verifyCode')->name('phn.verifyCode');

//Route::post('/users/login', 'HomeController@user_login')->name('user.login.submit');
Route::post('/users/login/cart', 'HomeController@cart_login')->name('cart.login.submit');
//Driver Routes
Route::get('/driver/all', 'DriverController@index')->name('driver.index');
...
Route::post('/driver/driver_update/{id}', 'DriverController@driver_update')->name('driver.driver_update');
Route::get('/driver/delete/{id}', 'DriverController@delete')->name('driver.delete');

//Order assign to driver
Route::get('/order/driver/{id}', 'OrderController@assign_driver')->name('order.driver');
Route::post('/driver/details', 'DriverController@details')->name('driver.details');
Route::post('/driver/insert', 'DriverController@insert')->name('driver.insert');

//Deliver and Non Deliver Order List
Route::get('/delivered/ordered', 'DriverController@delivered_ordered')->name('delivered.order');
Route::get('/non-delivered/ordered', 'DriverController@non_delivered_order')->name('non_delivered.driver');

//user phone number checking if exists
Route::post('/users/verify_number', 'HomeController@verify_number')->name('user.verify_number');
...
//Byanpay START
Route::get('/byanpay/payment','ByanpayController@payment')->name('byanpay.payment');
Route::post('/byanpay/payment','ByanpayController@post_payment')->name('byanpay.post_payment');
Route::post('/byanpay/payment/back','ByanpayController@payment_done');
//Byanpay END
